...
const sweepInterval = process.env.GAMESTORE_SWEEP_INTERVAL || 3600 // in seconds
const archiveThreshold = process.env.GAMESTORE_ARCHIVE_THRESHOLD || 7200 // in seconds
