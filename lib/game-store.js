...
class GameStore extends EventEmitter {
  archiveInterval = 2 * 60 * 60 * 1000 // two hours
  ...
  _loadGame(game) {
    ...
    console.info(`Loaded game ${game.id} with path ${game.path} and master ${game.master}`)
  ...
  _newGame(data) {
    ...
    console.info(`Started new game ${game.id}`)
